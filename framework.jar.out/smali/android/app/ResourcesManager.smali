...
.method public getTopLevelThemedResources(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Landroid/content/res/CompatibilityInfo;Landroid/os/IBinder;Z)Landroid/content/res/Resources;
    .locals 11
    .param p1, "resDir"    # Ljava/lang/String;
    ...
    invoke-virtual {v2, p3}, Landroid/content/res/AssetManager;->setAppName(Ljava/lang/String;)V

    .line 311
    move/from16 v0, p7

    invoke-virtual {v2, v0}, Landroid/content/res/AssetManager;->setThemeSupport(Z)V

    .line 312
    invoke-virtual {v2, p1}, Landroid/content/res/AssetManager;->addAssetPath(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v3, v4}, Landroid/app/ResourcesManager;->applyNonDefaultDisplayMetricsToConfigurationLocked(Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V
    ...
    .line 328
    .local v8, "iconsAttached":Z
    if-eqz p7, :cond_2

    .line 330
    new-instance v7, Landroid/content/res/ThemeConfig$Builder;

    invoke-direct {v7}, Landroid/content/res/ThemeConfig$Builder;-><init>()V

    .line 331
    .local v7, "builder":Landroid/content/res/ThemeConfig$Builder;
    invoke-virtual {v7, p4}, Landroid/content/res/ThemeConfig$Builder;->defaultOverlay(Ljava/lang/String;)Landroid/content/res/ThemeConfig$Builder;

    .line 332
    invoke-virtual {v7, p4}, Landroid/content/res/ThemeConfig$Builder;->defaultIcon(Ljava/lang/String;)Landroid/content/res/ThemeConfig$Builder;

    .line 333
    invoke-virtual {v7, p4}, Landroid/content/res/ThemeConfig$Builder;->defaultFont(Ljava/lang/String;)Landroid/content/res/ThemeConfig$Builder;

    .line 335
    invoke-virtual {v7}, Landroid/content/res/ThemeConfig$Builder;->build()Landroid/content/res/ThemeConfig;

    move-result-object v10

    .line 336
    .local v10, "themeConfig":Landroid/content/res/ThemeConfig;
    invoke-direct {p0, v2, v10}, Landroid/app/ResourcesManager;->attachThemeAssets(Landroid/content/res/AssetManager;Landroid/content/res/ThemeConfig;)Z

    .line 337
    invoke-direct {p0, v2, v10}, Landroid/app/ResourcesManager;->attachCommonAssets(Landroid/content/res/AssetManager;Landroid/content/res/ThemeConfig;)Z

    .line 338
    invoke-direct {p0, v2, v10}, Landroid/app/ResourcesManager;->attachIconAssets(Landroid/content/res/AssetManager;Landroid/content/res/ThemeConfig;)Z

    move-result v8

    .line 340
    .end local v7    # "builder":Landroid/content/res/ThemeConfig$Builder;
    .end local v10    # "themeConfig":Landroid/content/res/ThemeConfig;
    :cond_2
    ...
    invoke-direct {p0, v1}, Landroid/app/ResourcesManager;->setActivityIcons(Landroid/content/res/Resources;)V
